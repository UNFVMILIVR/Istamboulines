...
window.pluginsAttached ? alert('Attention: plugins.js library is attached twice and needs to be removed. The slides.min.js already contains both of scripts.') : window.pluginsAttached = 1, function (a) {
  a.extend(a, {
    cacheImage: function cacheImage(b, c) {
      if ('object' == _typeof(b)) return void a.each(b, function () {
    ...
    cacheImage: function cacheImage(b) {
  ...
  a.fn.swipe = function (c) {
    ...
    } else if (!(e || 'object' != _typeof(c) && c)) return b.apply(this, arguments);
  ...
  var g = 'sharrre',
    ...
    pinterest: 'http://api.pinterest.com/v1/urls/count.json?url={url}&callback=?'
      ...
      j = {
    googlePlus: function googlePlus(d) {
    ...
    delicious: function delicious(b) {
    ...
    stumbleupon: function stumbleupon(d) {
    ...
    pinterest: function pinterest(b) {
    ...
    pinterest: function pinterest() {}
      ...
      l = {
    googlePlus: function googlePlus(a) {
    ...
    delicious: function delicious(a) {
    ...
    stumbleupon: function stumbleupon(a) {
    ...
    pinterest: function pinterest(a) {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var a = document.documentElement,
    ...
    init: function init(a, d, e) {
      return this._wdw = a === b, this._target = a, this._tween = e, 'object' != _typeof(d) && (d = {
        y: d
  ...
  if (!c.TweenLite) {
    var d,
      ...
      this.check = function (j) {
        for (var k, l, m, n, q = e.length, r = q; --q > -1;) {
          (k = o[e[q]] || new p(e[q], [])).gsClass ? (h[q] = k.gsClass, r--) : j && k.sc.push(this);
        }
        ...
        if (0 === r && f) for (l = ('com.greensock.' + d).split('.'), m = l.pop(), n = i(l.join('.'))[m] = this.gsClass = f.apply(f, h), g && (c[m] = n, 'function' == typeof define && define.amd ? define((a.GreenSockAMDPath ? a.GreenSockAMDPath + '/' : '') + d.split('.').pop(), [], function () {
          return n;
        }) : d === b && 'undefined' != typeof module && module.exports && (module.exports = n)), q = 0; this.sc.length > q; q++) {
          this.sc[q].check();
        }
      }, this.check(!0);
    },
    ...
    f = E.prototype = new C(), f.constructor = E, f.kill()._gc = !1, f._first = f._last = f._recent = null, f._sortChildren = !1, f.add = f.insert = function (a, b) {
      var c, d;
      if (a._startTime = Number(b || 0) + a._delay, a._paused && this !== a._timeline && (a._pauseTime = a._startTime + (this.rawTime() - a._startTime) / a._timeScale), a.timeline && a.timeline._remove(a, !0), a.timeline = a._timeline = this, a._gc && a._enabled(!0, !0), c = this._last, this._sortChildren) for (d = a._startTime; c && c._startTime > d;) {
        c = c._prev;
      }
    ...
    var F = r('TweenLite', function (b, c, d) {
      ...
      if (this._overwrite = i = null == i ? P[F.defaultOverwrite] : 'number' == typeof i ? i >> 0 : P[i], (h || b instanceof Array || b.push && n(b)) && 'number' != typeof b[0]) for (this._targets = g = l(b), this._propLookup = [], this._siblings = [], e = 0; g.length > e; e++) {
        f = g[e], f ? 'string' != typeof f ? f.length && f !== a && f[0] && (f[0] === a || f[0].nodeType && f[0].style && !f.nodeType) ? (g.splice(e--, 1), this._targets = g = g.concat(l(f))) : (this._siblings[e] = U(f, this, !1), 1 === i && this._siblings[e].length > 1 && W(f, this, null, 1, this._siblings[e])) : (f = g[e--] = F.selector(f), 'string' == typeof f && g.splice(e + 1, 1)) : g.splice(e--, 1);
    ...
    var U = function U(a, b, c) {
      ...
      if (M[f || (a._gsTweenID = f = 't' + N++)] || (M[f] = {
        target: a,
        tweens: []
      }), b && (d = M[f].tweens, d[e = d.length] = b, c)) for (; --e > -1;) {
        d[e] === b && d.splice(e, 1);
      }
      return M[f].tweens;
    },
      ...
      for (f = e.length; --f > -1;) {
        (h = e[f]) === b || h._gc || h._paused || (h._timeline !== b._timeline ? (j = j || X(b, 0, o), 0 === X(h, j, o) && (m[n++] = h)) : l >= h._startTime && h._startTime + h.totalDuration() / h._timeScale > l && ((o || !h._initted) && 2e-10 >= l - h._startTime || (m[n++] = h)));
      }
    ...
    f._init = function () {
      ...
      if (a >= i) this._totalTime = this._time = i, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (d = !0, e = 'onComplete', c = c || this._timeline.autoRemoveChildren), 0 === i && (this._initted || !this.vars.lazy || c) && (this._startTime === this._timeline._duration && (a = 0), (0 === a || 0 > j || j === k && 'isPause' !== this.data) && j !== a && (c = !0, j > k && (e = 'onReverseComplete')), this._rawPrevTime = g = !b || a || j === a ? a : k);else if (1e-7 > a) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== h || 0 === i && j > 0) && (e = 'onReverseComplete', d = this._reversed), 0 > a && (this._active = !1, 0 === i && (this._initted || !this.vars.lazy || c) && (j >= 0 && (j !== k || 'isPause' !== this.data) && (c = !0), this._rawPrevTime = g = !b || a || j === a ? a : k)), this._initted || (c = !0);else if (this._totalTime = this._time = a, this._easeType) {
        var l = a / i,
            m = this._easeType,
            n = this._easePower;
        (1 === m || 3 === m && l >= 0.5) && (l = 1 - l), 3 === m && (l *= 2), 1 === n ? l *= l : 2 === n ? l *= l * l : 3 === n ? l *= l * l * l : 4 === n && (l *= l * l * l * l), this.ratio = 1 === m ? 1 - l : 2 === m ? l : 0.5 > a / i ? l / 2 : 1 - l / 2;
      ...
      } else for (d = U(a).concat(), c = d.length; --c > -1;) {
    ...
    if (f = Y.prototype, Y.version = '1.10.1', Y.API = 2, f._firstPT = null, f._addTween = function (a, b, c, d, e, f) {
      ...
      for (var b, c = this._firstPT, d = 1e-6; c;) {
        b = c.c * a + c.s, c.r ? b = Math.round(b) : d > b && b > -d && (b = 0), c.f ? c.t[c.p](b) : c.t[c.p] = b, c = c._next;
      }
    }, f._kill = function (a) {
      var b,
...
}('undefined' != typeof module && module.exports && 'undefined' != typeof global ? global : void 0 || window, 'TweenLite'), function (a, b) {
  'use strict';
  ...
  'function' == typeof define && define.amd ? define('get-size/get-size', [], function () {
    return b();
  }) : 'object' == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = b() : a.getSize = b();
}(window, function () {
  'use strict';
  ...
  function f(b) {
    if (e(), 'string' == typeof b && (b = document.querySelector(b)), b && 'object' == _typeof(b) && b.nodeType) {
      var f = d(b);
  ...
  c.extend = function (a, b) {
    ...
    var b = [];
    if (Array.isArray(a)) b = a;else if (a && 'object' == _typeof(a) && 'number' == typeof a.length) for (var c = 0; c < a.length; c++) {
      b.push(a[c]);
    } else b.push(a);
    return b;
  ...
  'function' == typeof define && define.amd ? define('outlayer/item', ['ev-emitter/ev-emitter', 'get-size/get-size'], b) : 'object' == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = b(require('ev-emitter'), require('get-size')) : (a.Outlayer = {}, a.Outlayer.Item = b(a.EvEmitter, a.getSize));
}(window, function (a, b) {
  'use strict';
  ...
  'function' == typeof define && define.amd ? define('outlayer/outlayer', ['ev-emitter/ev-emitter', 'get-size/get-size', 'fizzy-ui-utils/utils', './item'], function (c, d, e, f) {
    return b(a, c, d, e, f);
  }) : 'object' == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = b(a, require('ev-emitter'), require('get-size'), require('fizzy-ui-utils'), require('./item')) : a.Outlayer = b(a, a.EvEmitter, a.getSize, a.fizzyUIUtils, a.Outlayer.Item);
  ...
  'function' == typeof define && define.amd ? define(['outlayer/outlayer', 'get-size/get-size'], b) : 'object' == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = b(require('outlayer'), require('get-size')) : a.Masonry = b(a.Outlayer, a.getSize);
}(window, function (a, b) {
  ...
  function d(a) {
    ...
    var b = 'object' == _typeof(a) && 'number' == typeof a.length;
    return b ? j.call(a) : [a];
  }
  ...
  var a = function a() {
    ...
    var h, i, j, k;
    window.matchMedia ? h = window.matchMedia : (i = document.getElementsByTagName('head')[0], j = document.createElement('style'), i.appendChild(j), k = document.createElement('div'), k.className = 'mediaQueryBinarySearch', k.style.display = 'none', document.body.appendChild(k), h = function h(a) {
    ...
    return k && (i.removeChild(j), document.body.removeChild(k)), l;
      ...
      m = function () {
    var a = b;
    return isNaN(screen.logicalXDPI) || isNaN(screen.systemXDPI) ? window.navigator.msMaxTouchPoints ? a = d : window.chrome && !(window.opera || navigator.userAgent.indexOf(' Opera') >= 0) ? a = e : Object.prototype.toString.call(window.HTMLElement).indexOf('Constructor') > 0 ? a = f : 'orientation' in window && 'webkitRequestAnimationFrame' in window ? a = g : 'webkitRequestAnimationFrame' in window ? a = h : navigator.userAgent.indexOf('Opera') >= 0 ? a = k : window.devicePixelRatio ? a = j : i().zoom > 0.001 && (a = i) : a = c, a;
  }();
...
}), window.inAction = 1, window.allowSlide = 1, window.blockScroll = 1, window.effectOffset = 500, window.effectSpeed = 1e3, window.slideSpeed = 1e3, window.cleanupDelay = 1400, window.horizontalMode = 0, window.sidebarShown = 0, window.loadingProgress = 0, window.smoothScroll = 0, window.scrollSpeed = 0.5, window.preload = 1, window.setHashLink = 1, window.hideSidebarOnBodyClick = 1, window.collectScrolls = 0, window.sliderStatus = 0, window.minScrollToSlide = 500, window.minSwipeToSlide = 4, window.enableMobileZoom = 0, window.hideOnScrollSensitivity = 100, window.allowParallaxOnMobile = 1, window.hidePopupOnBodyClick = 1;
var $html = $('html');
$(window).on('load', function () {
  ...
  function f() {
    p++, p >= 2 && (m(), p = 0), $('.slide').each(function (a, b) {
      var c = $(b),
          ...
          k = 2 * ((e + window.windowHeight - f) / (window.windowHeight + g) - 0.5),
          l = !0;
  ...
  if ($('.mobile .slides:not(.scroll):not(.simplifiedMobile), .slides.desktopSwipe').swipe({
    swipeStatus: function swipeStatus(a, b, c, d) {
