  ...
  (function (a) {
    ...
    function c(b, c) {
        ...
        if (!(ja() || a(b.target).closest(c.excludedElements, Sa).length > 0)) {
          ...
          return (
            ...
            !y || Ua === c.fingers || c.fingers === s || R()
              ? (la(0, f),
                (Wa = Aa()),
                2 == Ua && (la(1, e.touches[1]), (Ma = Na = ua(Va[0].start, Va[1].start))),
      ...
      function D(a) {
        ...
        if (Ta !== w && Ta !== x && !ia()) {
          ...
          if (
            ...
            2 == Ua &&
              (0 == Ma
                ? (la(1, b.touches[1]), (Ma = Na = ua(Va[0].start, Va[1].start)))
                : (ma(b.touches[1]),
      ...
      function K(b, j, k) {
        ...
        if (k == l) {
          if (
            (Sa.trigger('swipeStatus', [j, Ka || null, Ja || 0, La || 0, Ua, Va]),
            c.swipeStatus &&
              ((q = c.swipeStatus.call(Sa, b, j, Ka || null, Ja || 0, La || 0, Ua, Va)), q === !1))
          )
            return !1;
          if (j == w && T()) {
            if (
              (Sa.trigger('swipe', [Ka, Ja, La, Ua, Va]),
              c.swipe && ((q = c.swipe.call(Sa, b, Ka, Ja, La, Ua, Va)), q === !1))
            )
              return !1;
            switch (Ka) {
              case d:
        ...
        if (k == m) {
          if (
            (Sa.trigger('pinchStatus', [j, Qa || null, Pa || 0, La || 0, Ua, Oa, Va]),
            c.pinchStatus &&
              ((q = c.pinchStatus.call(Sa, b, j, Qa || null, Pa || 0, La || 0, Ua, Oa, Va)),
              q === !1))
          )
            return !1;
          if (j == w && Q())
            switch (Qa) {
              case h:
                Sa.trigger('pinchIn', [Qa || null, Pa || 0, La || 0, Ua, Oa, Va]),
                  c.pinchIn &&
                    (q = c.pinchIn.call(Sa, b, Qa || null, Pa || 0, La || 0, Ua, Oa, Va));
                break;
              case i:
                Sa.trigger('pinchOut', [Qa || null, Pa || 0, La || 0, Ua, Oa, Va]),
                  c.pinchOut &&
                    (q = c.pinchOut.call(Sa, b, Qa || null, Pa || 0, La || 0, Ua, Oa, Va));
            }
        }
        return (
          k == n
      ...
      function M() {
        var a = !1;
        return (
          null !== c.cancelThreshold && null !== Ka && (a = qa(Ka) - Ja >= c.cancelThreshold), a
        );
      }
      ...
      function ka(a) {
        a === !0
          ...
          : (Sa.unbind(Fa, D, !1), Sa.unbind(Ga, E, !1), Ha && Sa.unbind(Ha, G, !1)),
        ...
        googlePlus: function (a) {
          b.open(
            'https://plus.google.com/share?hl=' +
              ...
              '&url=' +
              encodeURIComponent(
                '' !== a.buttons.googlePlus.url ? a.buttons.googlePlus.url : a.url
              ),
            '',
        ...
        facebook: function (a) {
          b.open(
            'http://www.facebook.com/sharer/sharer.php?u=' +
              encodeURIComponent('' !== a.buttons.facebook.url ? a.buttons.facebook.url : a.url) +
              '&t=' +
              a.text,
            '',
            'toolbar=0, status=0, width=900, height=500'
        ...
        twitter: function (a) {
          b.open(
            'https://twitter.com/intent/tweet?text=' +
              ...
              '&url=' +
              encodeURIComponent('' !== a.buttons.twitter.url ? a.buttons.twitter.url : a.url) +
              ('' !== a.buttons.twitter.via ? '&via=' + a.buttons.twitter.via : ''),
            '',
        ...
        digg: function (a) {
          b.open(
            'http://digg.com/tools/diggthis/submit?url=' +
              encodeURIComponent('' !== a.buttons.digg.url ? a.buttons.digg.url : a.url) +
              '&title=' +
              a.text +
        ...
        delicious: function (a) {
          b.open(
            'http://www.delicious.com/save?v=5&noui&jump=close&url=' +
              encodeURIComponent('' !== a.buttons.delicious.url ? a.buttons.delicious.url : a.url) +
              '&title=' +
              a.text,
            'delicious',
        ...
        pinterest: function (a) {
          b.open(
            'http://pinterest.com/pin/create/button/?url=' +
              encodeURIComponent('' !== a.buttons.pinterest.url ? a.buttons.pinterest.url : a.url) +
              '&media=' +
    ...
    (b.prototype.listen = function () {
      ...
      (b.prototype._zoom = function (a) {
        ...
        if (b && 'IMG' == b.tagName && !this._body.classList.contains('zoom-overlay-open')) {
          if (a.metaKey || a.ctrlKey)
            return window.open(
              a.target.getAttribute('data-original') || a.target.currentSrc || a.target.src,
              '_blank'
            );
      ...
      (b.prototype._touchMove = function (a) {
        Math.abs(a.touches[0].pageY - this._initialTouchPosition) > 10 &&
          (this._activeZoomClose(), a.target.removeEventListener('touchmove', h));
      }),
      (c.OFFSET = 80),
      (c._MAX_WIDTH = 2560),
      (c._MAX_HEIGHT = 4096),
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    d = _gsScope._gsDefine.plugin({
      ...
      init: function (a, d, e) {
        return (
          ...
          null != d.x
            ? (this._addTween(this, 'x', this.x, 'max' === d.x ? c(a, 'x') : d.x, 'scrollTo_x', !0),
              this._overwriteProps.push('scrollTo_x'))
            : (this.skipX = !0),
          null != d.y
            ? (this._addTween(this, 'y', this.y, 'max' === d.y ? c(a, 'y') : d.y, 'scrollTo_y', !0),
    ...
    if (!c.TweenLite) {
      ...
      var s = [0, 0, 1, 1],
        ...
        w = (u.register = function (a, b, c, d) {
          for (
            ...
            for (
              f = i[k], e = d ? r('easing.' + f, null, !0) : j.easing[f] || {}, g = l.length;
              --g > -1;
      ...
      r('Ticker', function (a, b) {
        ...
        x.call(j),
          ...
          (j.sleep = function () {
            null != e &&
              (n && z ? z(e) : clearTimeout(e), (d = m), (e = null), j === g && (h = !1));
          }),
          (j.wake = function () {
        ...
        (f.eventCallback = function (a, b, c, d) {
          if ('on' === (a || '').substr(0, 2)) {
            ...
            null == b
              ...
              : ((e[a] = b),
                (e[a + 'Params'] =
                  n(c) && -1 !== c.join('').indexOf('{self}') ? this._swapSelfInParams(c) : c),
                (e[a + 'Scope'] = d)),
          ...
          return (
            a != this._paused &&
              ...
              !a &&
                ...
                this.duration() &&
                this.render(
                  d.smoothChildTiming ? this._totalTime : (b - this._startTime) / this._timeScale,
                  !0,
                  !0
                )),
      ...
      var F = r(
          ...
          function (b, c, d) {
            ...
            if (
              ((this._overwrite = i =
                null == i ? P[F.defaultOverwrite] : 'number' == typeof i ? i >> 0 : P[i]),
      ...
      var U = function (a, b, c) {
          var d,
            ...
            f = a._gsTweenID;
          if (
            (M[f || (a._gsTweenID = f = 't' + N++)] || (M[f] = { target: a, tweens: [] }),
          ...
          for (f in this.vars) {
            if (((k = this.vars[f]), O[f]))
              ...
              (this._firstPT =
                ...
                (j.s = j.f
                  ? b[
                      f.indexOf('set') || 'function' != typeof b['get' + f.substr(3)]
                        ? f
                        : 'get' + f.substr(3)
                    ]()
                  : parseFloat(b[f])),
  ...
  (function (a, b) {
    ...
    function d(a, b) {
      a &&
        ((this.element = a), (this.layout = b), (this.position = { x: 0, y: 0 }), this._create());
    }
  ...
  (function (a, b) {
    ...
    function f(a, b) {
      ...
      if (!c)
        return void (
          i && i.error('Bad element for ' + this.constructor.namespace + ': ' + (c || a))
        );
      (this.element = c),
    ...
    d.extend(n, b.prototype),
      ...
      (n._itemize = function (a) {
        for (
          var b = this._filterFindItemElements(a), c = this.constructor.Item, d = [], e = 0;
          e < b.length;
          e++
        ) {
          var f = b[e],
      ...
      (n._find = function (a) {
        return a
          ? ('string' == typeof a && (a = this.element.querySelectorAll(a)), (a = d.makeArray(a)))
          : void 0;
      }),
  ...
  (function (a, b) {
    ...
    return (
      ...
      (d._manageStamp = function (a) {
        ...
        for (
          var j = this._getOption('originTop'), k = (j ? d.top : d.bottom) + c.outerHeight, l = h;
          i >= l;
          l++
        )
    ...
    (a.fn.attr2 = function () {
      ...
      (a.fn.ajaxSubmit = function (b) {
              ...
              if ((E && E.location.href != m.iframeSrc) || v) {
                ...
                try {
                  ...
                  if (
                    ...
                    return (
                      d('requeing onLoad callback, DOM not available'), void setTimeout(h, 250)
                    );
                  ...
                  if (k || m.textarea) {
                    ...
                    if (l)
                      ...
                      o
                        ? (s.responseText = o.textContent ? o.textContent : o.innerText)
                        : p && (s.responseText = p.textContent ? p.textContent : p.innerText);
                    }
                  } else
                    'xml' == j &&
                      !s.responseXML &&
          ...
          (t = x.clk),
            t &&
              ...
              u &&
                ...
                'image' == t.type &&
                  ((m.extraData[u + '.x'] = x.clk_x), (m.extraData[u + '.y'] = x.clk_y))));
          var z = 1,
            A = 2,
        ...
        o && (r = r ? r + '&' + o : o),
          'GET' == b.type.toUpperCase()
            ? ((b.url += (b.url.indexOf('?') >= 0 ? '&' : '?') + r), (b.data = null))
            : (b.data = r);
        var s = [];
        if (
          (b.resetForm &&
      ...
      (a.fn.formToArray = function (b, c) {
        ...
        if (
          ...
          h && ((f = a(':input[form="' + h + '"]').get()), f.length && (i = (i || []).concat(f))),
          !i || !i.length)
        )
          return d;
        var j, k, l, m, n, o, p;
        for (j = 0, o = i.length; o > j; j++)
          if (((n = i[j]), (l = n.name), l && !n.disabled))
            if (b && g.clk && 'image' == n.type)
              ...
              null !== m &&
                'undefined' != typeof m &&
                (c && c.push(n), d.push({ name: l, value: m, type: n.type, required: n.required }));
        if (!b && g.clk) {
          var r = a(g.clk),
            s = r[0];
          (l = s.name),
          ...
          return this.each(function () {
            ...
            c.test(d) || 'textarea' == e
              ...
              ? /MSIE/.test(navigator.userAgent)
                ...
                : a(this).val('')
              : b &&
                ((b === !0 && /hidden/.test(d)) || ('string' == typeof b && a(this).is(b))) &&
                (this.value = '');
          });
        }),
  ...
  ($.cookie = function (a, b, c) {
    ...
    var f,
      g = c.raw
        ...
        : decodeURIComponent;
    return (f = new RegExp('(?:^|; )' + encodeURIComponent(a) + '=([^;]*)').exec(document.cookie))
      ? g(f[1])
      : null;
  }),
  !(function (a, b, c) {
    ...
    var a = function () {
      ...
      h = function () {
        ...
        d.setAttribute(
          'style',
          b('width:0; height:0; overflow:hidden; visibility:hidden; position: absolute;')
        ),
          d.appendChild(c),
      ...
      i = function () {
        ...
        return (a = Math.round(100 * a) / 100), { zoom: a, devicePxPerCssPx: a };
      },
      j = function () {
      ...
      k = function () {
        ...
        return (b = Math.round(100 * b) / 100), { zoom: b, devicePxPerCssPx: b * a() };
      },
      l = function (a, b, c, d, e, f) {
        ...
        window.matchMedia
          ...
          : ((i = document.getElementsByTagName('head')[0]),
            ...
            (h = function (a) {
              j.sheet.insertRule(
                '@media ' + a + '{.mediaQueryBinarySearch {text-decoration: underline} }',
                0
              );
...
$(window).on('load', function () {
  ...
  $(document).ready(function () {
    ...
    function d(a) {
      if (
        ((a = parseInt(a)), !((window.isMobile && window.isSimplifiedMobile) || window.isScroll))
      ) {
        h();
        var b = $('.slide').eq(a - 1),
          c = $('.slide.selected'),
        ...
        m(),
          ...
          window.setHashLink &&
            (b.attr('data-name') || b.attr('id')
              ? (window.location.hash = b.attr('data-name') ? b.attr('data-name') : b.attr('id'))
    ...
    function e(a) {
      $('.zoom-overlay-open').length > 0 &&
        ($('.zoom-img').click(), a && $('.zoom-img-wrap, .zoom-overlay').remove());
    }
        ...
        $(v).length > 0 &&
          $(v).each(function (a, b) {
            ...
            e !== -1
              ...
              : d &&
                ((e = $('.slide[data-slide-id="' + d + '"]').index('.slide:not(.exclude)')),
                $(b).find('li').eq(e).addClass('selected'));
          });
      }, 100);
    }
    ...
    if (
      ...
      n.hasClass('animated')
        ...
        : n.hasClass('animateOnEvent') &&
          ...
          window.isMobile &&
            ((window.isAnimated = 'auto'), n.removeClass('animateOnEvent').addClass('animated'))),
    ...
    d(window.stage),
      ...
      (window.changeSlide = function (a) {
        if (
          ('increase' === a
            ? (a = window.stage + 1 >= window.stages ? window.stages : window.stage + 1)
            : 'decrease' === a && (a = window.stage - 1 < 1 ? 1 : window.stage - 1),
          (window.isMobile && window.isSimplifiedMobile) || window.isScroll)
        ) {
          window.stage = a;
      ...
      if (c) {
        ...
        window.isScroll ||
          ...
          (j > window.windowHeight &&
            (('up' === h && 0 === b.scrollTop()) ||
            ('down' === h && b.scrollTop() + window.windowHeight >= Math.floor(j / k))
              ? (window.allowSlide = 1)
              : (window.allowSlide = 0),
            window.panelsToHide &&
          ...
          Math.abs(window.collectScrolls) >= l &&
            ...
            (('down' === h && window.stage !== window.stages) ||
              ('up' === h && 1 !== window.stage)) &&
              1 !== window.inAction &&
              ('down' === h ? window.changeSlide('increase') : window.changeSlide('decrease'))));
      }
    }),
      ((window.isMobile && window.isSimplifiedMobile) || window.isScroll) &&
    ...
    if (
      ...
      $('.panel.hideOnScroll').length > 0 &&
        ((window.panelsToHide = !0), window.isScroll || window.isSimplifiedMobile))
    ) {
      var q,
        r = 0,
      ...
      $(window).on('mousewheel', function (a) {
        ...
        b > q
          ...
          (q = b),
          (b + window.windowHeight + s >= window.documentHeight || b + s <= 0) &&
            c.removeClass('hide');
      });
    }
    $(document).on('keydown', function (a) {
      ...
      window.window.disableKeyNavigation ||
        ...
        (37 === a.keyCode &&
          (a.preventDefault(), window.horizontalMode && window.changeSlide('decrease')),
        38 === a.keyCode &&
          (window.horizontalMode
            ? (a.preventDefault(),
    ...
    $(v).length > 0 &&
      ...
      $("a[href^='#'][target!='_blank']").click(function (a) {
        ...
        if (e.length > 0) {
          if (
            (a.preventDefault(), (window.isMobile && window.isSimplifiedMobile) || window.isScroll)
          ) {
            var f = e;
            f.length &&
              $('html,body').stop().clearQueue().animate({ scrollTop: f.position().top }, 1e3),
    ...
    $(x).length > 0 &&
      $(x).each(function (a, b) {
        ...
        if (
          (window.sliderStatus &&
            $html.removeClassByPrefix('slider_' + d).addClass('slider_' + d + '_' + e),
          c.hasClass('autoplay'))
        ) {
          ...
          0 != c.data('slider-stoponclick') &&
            $('[data-slider-id="' + d + '"]').on('mousedown touchstart', function () {
              clearInterval(g);
            });
        }
        (c.hasClass('clickable') || c.hasClass('autoplay')) &&
          c.on('click next', function (a) {
            ...
            'cancel' != $(i).data('slider-event') &&
              ...
              window.sliderStatus &&
                $html.removeClassByPrefix('slider_' + f).addClass('slider_' + f + '_' + e),
              h &&
    ...
    $('[data-slider-action]').click(function () {
      if ($(this).data('slider-id')) {
        ...
        'next' === e
          ...
          : 'prev' === e
          ? (a = i.prevOrLast('li'))
          : (parseInt(e) || 0 === e) && ((b = parseInt(e)), (a = f.find('>li:eq(' + b + ')'))),
          (b = a.index()),
          i.removeClass('selected'),
          a.removeClass('hide').addClass('selected'),
          window.sliderStatus &&
            $html.removeClassByPrefix('slider_' + d).addClass('slider_' + d + '_' + b),
          j &&
            (f.addClass('animateOnEvent'),
            f.find('li').removeClassByPrefix('ae-').removeClass('do'),
            f.find('.selected').each(function (a) {
      ...
      $('.dialog [data-dialog-action="close"], .dialog [data-dialog-action="hide"]').on(
        'click',
        function () {
      ...
      $('.soundTrigger').click(function () {
        ...
        !b[0].paused || ('toggle' !== c && 'play' !== c)
          ...
          : (b[0].play(), b.animate({ volume: 1 }, d), $(this).addClass('playing'));
      });
  }),
  (window.isMobile = !1),
